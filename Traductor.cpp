/**TRADUCTOR DE ORACIONES DE ESPAÑOL A INGLES SIMPLE.
...
void traduccion(char *frase,int np){
    ...
    string palabras[100][2] = {{"yo","I"},{"tu","you"},{"él","he"},{"ella","she"},{"este","it"},{"muy","very"},
    {"nosotros","we"},{"ustedes","you"},{"ellos","they"},{"hola","hello"},{"como","how"},{"estas", "are you"},{"ama","loves you"},
    {"estoy","am"},{"bien","fine"},{"cansado","tired"},{"donde","where"},{"jesus","Jesus"},{"niño,child"},{"ciudad","city"},
    {"mi","my"},{"amo","love you"},{"quiero","love you"},{"eres","you are"},{"hombre","man"},{"amor","love"},
    {"leer","to read"},{"mucho","so much"},{"hermosa","beautiful"},{"extraño","miss you"},{"necesito","meed you"},{"vida","life"}};
